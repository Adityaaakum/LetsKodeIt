...
import com.letsKodeIt.utils.ExtentManager;

public class TestListnerss  extends CommonBaseClass implements ITestListener{
	
	                 ExtentReports extentReports=   ExtentManager.getInstance();
	                 ThreadLocal<ExtentTest> extentTest= new ThreadLocal<ExtentTest>();
	                 private static final Logger log= LogManager.getLogger(TestListnerss.class);
	               ...
	               /*  * Invoked after the test class is instantiated and before
	                ...
	                public void onTestFailure(ITestResult result) {
	                    ...
	                    String browser = FactoryClassDriver.getFactoryinstance().getBrowser();
	                    WebDriver driver = FactoryClassDriver.getFactoryinstance().getDriver(browser);
